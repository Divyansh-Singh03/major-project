...
export default function Login() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "absolute", top: "15%", left: "20%", width: 300, height: 300, background: "#22c55e0d", borderRadius: "50%", filter: "blur(80px)" }} />
      <div style={{ position: "absolute", bottom: "15%", right: "15%", width: 250, height: 250, background: "#6366f10d", borderRadius: "50%", filter: "blur(80px)" }} />
      ...
      <div style={{
        ...
        <p style={{ margin: "0 0 28px", fontSize: 13, color: "#475569" }}>Sign in to your portfolio dashboard</p>
        ...
        <p style={{ margin: "22px 0 0", fontSize: 13, textAlign: "center", color: "#475569" }}>
          ...
          <span onClick={() => navigate("/signup")} style={{ color: "#22c55e", cursor: "pointer", fontWeight: 600 }}>
            Create one
          </span>
        </p>
      </div>
